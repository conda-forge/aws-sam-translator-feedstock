...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aws-sam-translator-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws-sam-translator-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
```
mamba install aws-sam-translator
```
...
pixi add aws-sam-translator
# for installing globally
pixi global install aws-sam-translator
```
...
It is possible to list all of the versions of `aws-sam-translator` available on your platform:
...
```
mamba search aws-sam-translator --channel conda-forge
```
...
```
pixi search aws-sam-translator --channel conda-forge
```
...
mamba repoquery search aws-sam-translator --channel conda-forge

# List packages depending on `aws-sam-translator`:
mamba repoquery whoneeds aws-sam-translator --channel conda-forge

# List dependencies of `aws-sam-translator`:
mamba repoquery depends aws-sam-translator --channel conda-forge
```
