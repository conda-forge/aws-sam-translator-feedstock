...
Once the `conda-forge` channel has been enabled, `aws-sam-translator` can be installed with `conda`:
...
It is possible to list all of the versions of `aws-sam-translator` available on your platform with `conda`:
